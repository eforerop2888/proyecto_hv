...
|
*/
$config['ldap_server']="ldap://192.168.0.20/"; //set this to your LDAP server name.
$config['user_prefix']="SIMPLE\\"; //if you specify your domain you must escape the backslash '\' with a backslash '\\'
