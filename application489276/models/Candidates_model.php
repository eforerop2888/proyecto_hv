...
class Candidates_model extends CI_Model {
    ...
    // Función para la actualizacion de los campos formulario de registro en base de datos
    public function update ( $data, $contrasena, $file = NULL, $id )
    {
		...
		$this->db->where( 'smp_hv_candidates', $id );
		$this->db->update( 'smp_hv_candidates', $datos );
		$insert_id = $this->db->insert_id();
