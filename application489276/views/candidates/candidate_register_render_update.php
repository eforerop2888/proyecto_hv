		<!-- 
		 *Vista actualización de usuarios
		-->
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'autofocus'     => 'autofocus',
										        'value'			=> $candidate_detail->nombre_completo
											);
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<?php 
											...
											echo form_dropdown('tipo_documento', $options, $candidate_detail->tipo_documento_id, $data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'value'			=> $candidate_detail->numero_documento
											);
											echo form_input($data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'value'			=> $candidate_detail->correo_electronico
											);
											echo form_input($data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'value'			=> $candidate_detail->telefono
											);
											echo form_input($data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
												...
												'value'			=> $candidate_detail->direccion_residencia
											);
											echo form_input($data);
										?>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<?php 
											...
											echo form_dropdown('estado_civil', $options, $candidate_detail->estado_civil_id, $data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'value'			=> $candidate_detail->fecha_nacimiento
											);
											echo form_input($data);
										?>
									...
									<div class="form-group">
										...
										<?php 
											$data = array(
										        ...
										        'value'			=> $candidate_detail->lugar_nacimiento
											);
											echo form_input($data);
										?>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="cloned_info_academica">
							<?php foreach ($candidate_formacion as $row_academica) { ?>
								<div class="row border_info">
									<div class="col-md-3">
										<div class="form-group">
											...
											<?php 
												...
												echo form_dropdown('niveles_educacion[]', $options, $row_academica->nivel_educacion_id, $data);
											?>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_academica->titulo_otorgado
												);
												echo form_input($data);
											?>
											</div>
										...
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_academica->nombre_institucion
												);
												echo form_input($data);
											?>
										</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="cloned_info_laboral">
							<?php foreach ($candidate_experiencia as $row_experiencia) { ?>
								<div class="row border_info">
									<div class="col-md-4">
										<div class="form-group">
										...
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_experiencia->salario_basico
												);
												echo form_input($data);
											?>
										</div>
										...
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_experiencia->beneficios
												);
												echo form_input($data);
											?>
										</div>
										...
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_experiencia->fecha_ingreso
												);
												echo form_input($data);
											?>
										...
										<div class="form-group">
											...
											<?php 
												$data = array(
											        ...
											        'value'			=> $row_experiencia->fecha_retiro
												);
												echo form_input($data);
											?>
